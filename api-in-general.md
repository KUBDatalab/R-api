...
![Structure of what is happening behind the scenes when we request a webpage](fig/http-structure.png){alt="Illustration of a http-request"}
...
with the server, the address and path of the server, and the information
...
The URL "[https://icanhazdadjoke.com/search?term=dog](https://icanhazdadjoke.com/search?term=dog){target="_blank"}" is asking the
...
![Content of a GET header](fig/GET-headers.png){alt="Illustration of the content of a GET request"}
...
![Contents of a POST header](fig/POST-headers.png){alt="Illustration of the content of a POST request"}
